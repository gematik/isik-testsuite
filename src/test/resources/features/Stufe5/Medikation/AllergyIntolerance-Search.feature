  ...
  Scenario: Precondition
    ...
    """
      ...
      - This Search Scenario performs the following conditions exist:
        * At least one Resource with ID as specified in the property 'medication-allergyintolerance-read-id'
        * At least one Resource with clinical-status 'active'
        * At least one Resource with type 'allergy'
        * At least one Resource with patient that references to the ID as specified in the property 'medication-allergyintolerance-read-patient-id'
