...
Feature: Read Information from a resource of type AllergyIntolerance (@AllergyIntolerance-Read)
  ...
  Scenario: Precondition
    ...
    """
      ...
      - The ID of the corresponding FHIR resource for this test data set must be stored in the configuration variable 'allergyintolerance-read-id'.

      Create an AllergyIntolerance resource in your system, with the following values:

      * ID: a valid Id (can be configured with the property 'allergyintolerance-read-id')
      ...
      * Patient: reference to a valid Patient Id (can be configured with the property 'allergyintolerance-read-patient-id')
      * Encounter: reference to a valid Encounter Id (can be configured with the property 'allergyintolerance-read-encounter-id')
      * Recorder: any display value
      * Asserter: any display value
      * Start Date of the Allergy/Intolerance: any
      * Recorded Date: any
      * Note:
        - Author Reference: reference to a valid Person/Role/Organization (can be configured with the property 'allergyintolerance-read-note-author-id')
